const dashboard = angular.module('average-sales-order-price', ['ideUI', 'ideView']);

dashboard.controller('AverageSalesOrderPriceController', ['$scope', '$document', '$http', 'messageHub', function ($scope, $document, $http, messageHub) {
    $scope.state = {
        isBusy: true,
        error: false,
        busyText: "Loading...",
