const dashboard = angular.module('top-sales-order', ['ideUI', 'ideView']);

dashboard.controller('TopSalesOrdersController', ['$scope', '$document', '$http', 'messageHub', function ($scope, $document, $http, messageHub) {
    $scope.state = {
        isBusy: true,
        error: false,
        busyText: "Loading...",
