const dashboard = angular.module('top-customer', ['ideUI', 'ideView']);

dashboard.controller('TopCustomerController', ['$scope', '$document', '$http', 'messageHub', function ($scope, $document, $http, messageHub) {
    $scope.state = {
        isBusy: true,
        error: false,
        busyText: "Loading...",
